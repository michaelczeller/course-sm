...
- platforms not useful: algorithms favour sensationalism?
- online activity often encourages "slacktivism"
- movements online face greater surveillance? 
...
- should online platforms be more regulated to prevent movements spreading misinformation?

:::

::: {style="margin-top: -40px;"}
[[Questions about movements]{style="color:violet;"}: (1) online activity important to the movement? (2) most important use of online tools for this movement? (3) new supporters first encounter movement online? (4) online participation often leads to offline participation? (5) most important platform for the movement? (6) movement has been affected by content moderation policies? (7) online participation gives supporters a sense of belonging?]{style="font-size: 0.7em;"}
:::
...
## Movement responses - online importance 

:::: {.columns}
:::{.column width="48%"}

online activity important to the movement
<!-- likert -->

```{ojs}
// need to replace 'm_online_important'

m_online_importantCounts = aq.from(surveyResults)
  .groupby("m_online_important", "movement")
  .count()
  .objects();

plot_m_online_important = Plot.plot({
  marks: [
    Plot.frame({
      fill: "#f7f7f7",
      stroke: "black",
    ...
    Plot.barY(m_online_importantCounts, {
      fx: "m_online_important",
      x: "movement",
      y: "count",
      fill: "movement",
      stroke: "white"
...
most important use of online tools for movement
<!-- other -->

```{ojs}
// need to replace 'm_most_important_use'

m_most_important_useCounts = aq.from(surveyResults)
  .groupby("m_most_important_use", "movement")
  .count()
  .objects();

plot_m_most_important_use = Plot.plot({
  marks: [
    Plot.frame({
      fill: "#f7f7f7",
      stroke: "black",
    ...
    Plot.barY(m_most_important_useCounts, {
      fx: "m_most_important_use",
      x: "movement",
      y: "count",
      fill: "movement",
      stroke: "white"
...
## Movement responses - linking to offline

:::: {.columns}
:::{.column width="48%"}

new supporters first encounter the movement online
<!-- ynm --> 

```{ojs}
// need to replace 'm_first_encounter_online'

m_first_encounter_onlineCounts = aq.from(surveyResults)
  .groupby("m_first_encounter_online", "movement")
  .count()
  .objects();

plot_m_first_encounter_online = Plot.plot({
  marks: [
    Plot.frame({
      fill: "#f7f7f7",
      stroke: "black",
    ...
    Plot.barY(m_first_encounter_onlineCounts, {
      fx: "m_first_encounter_online",
      x: "movement",
      y: "count",
      fill: "movement",
      stroke: "white"
...
```{ojs}
// need to replace 'm_online_to_offline'

m_online_to_offlineCounts = aq.from(surveyResults)
  .groupby("m_online_to_offline", "movement")
  .count()
  .objects();

plot_m_online_to_offline = Plot.plot({
  marks: [
    Plot.frame({
      fill: "#f7f7f7",
      stroke: "black",
    ...
    Plot.barY(m_online_to_offlineCounts, {
      fx: "m_online_to_offline",
      x: "movement",
      y: "count",
      fill: "movement",
      stroke: "white"
...
## Movement responses - key platform 

most important online platform 
<!-- other -->

```{ojs}
// need to replace 'm_important_platform'

m_important_platformCounts = aq.from(surveyResults)
  .groupby("m_important_platform", "movement")
  .count()
  .objects();

plot_m_important_platform = Plot.plot({
  marks: [
    Plot.frame({
      fill: "#f7f7f7",
      stroke: "black",
    ...
    Plot.barY(m_important_platformCounts, {
      fx: "m_important_platform",
      x: "movement",
      y: "count",
      fill: "movement",
      stroke: "white"
...
## Movement responses - content moderation 

movement affected by content moderation
<!-- ynm -->

```{ojs}
// need to replace 'm_affected_by_content_moderation'

m_affected_by_content_moderationCounts = aq.from(surveyResults)
  .groupby("m_affected_by_content_moderation", "movement")
  .count()
  .objects();

plot_m_affected_by_content_moderation = Plot.plot({
  marks: [
    Plot.frame({
      fill: "#f7f7f7",
      stroke: "black",
    ...
    Plot.barY(m_affected_by_content_moderationCounts, {
      fx: "m_affected_by_content_moderation",
      x: "movement",
      y: "count",
      fill: "movement",
      stroke: "white"
...
## Movement responses - collective identity 

Online participation gives supporters a sense of belonging
<!-- likert -->

```{ojs}
// need to replace 'm_online_brings_belonging'

m_online_brings_belongingCounts = aq.from(surveyResults)
  .groupby("m_online_brings_belonging", "movement")
  .count()
  .objects();

plot_m_online_brings_belonging = Plot.plot({
  marks: [
    Plot.frame({
      fill: "#f7f7f7",
      stroke: "black",
    ...
    Plot.barY(m_online_brings_belongingCounts, {
      fx: "m_online_brings_belonging",
      x: "movement",
      y: "count",
      fill: "movement",
      stroke: "white"
...
[Questions about movements next meeting]{style="color:violet;"}: (1) How influential has the movement been? (2) Does participation in the movement have lasting effects on participants' lives? (3) Has the movement inspired the formation of new organisations or initiatives? (4) Which political area has been most affected by the movement? (5) Which cultural impact has been most significant? (6) Which factor best explains this movement's success?
