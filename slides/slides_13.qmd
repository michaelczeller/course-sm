...
## Theories of social movements, conceptual origins {.scrollable}
...
- most common factor leading to movement decline? 
...
- institutionalisation = more effective pursuit of goals?
...
## Movement responses - current activity

:::: {.columns}
:::{.column width="48%"}

movement's current level of mobilisation
<!-- other -->

```{ojs}
// need to replace 'm_current_mobilisation'

m_current_mobilisationCounts = aq.from(surveyResults)
  .groupby("m_current_mobilisation", "movement")
  .count()
  .objects();

plot_m_current_mobilisation = Plot.plot({
  marks: [
    Plot.frame({
      fill: "#f7f7f7",
      stroke: "black",
    ...
    Plot.barY(m_current_mobilisationCounts, {
      fx: "m_current_mobilisation",
      x: "movement",
      y: "count",
      fill: "movement",
      stroke: "white"
...
movement recovered after periods of decline
<!-- likert -->

```{ojs}
// need to replace 'm_recovered_after_decline'

m_recovered_after_declineCounts = aq.from(surveyResults)
  .groupby("m_recovered_after_decline", "movement")
  .count()
  .objects();

plot_m_recovered_after_decline = Plot.plot({
  marks: [
    Plot.frame({
      fill: "#f7f7f7",
      stroke: "black",
    ...
    Plot.barY(m_recovered_after_declineCounts, {
      fx: "m_recovered_after_decline",
      x: "movement",
      y: "count",
      fill: "movement",
      stroke: "white"
...
## Movement responses - demobilising pressure 

most important demobilising pressure 
<!-- other -->

```{ojs}
// need to replace 'm_important_demob_pressure'

m_important_demob_pressureCounts = aq.from(surveyResults)
  .groupby("m_important_demob_pressure", "movement")
  .count()
  .objects();

plot_m_important_demob_pressure = Plot.plot({
  marks: [
    Plot.frame({
      fill: "#f7f7f7",
      stroke: "black",
    ...
    Plot.barY(m_important_demob_pressureCounts, {
      fx: "m_important_demob_pressure",
      x: "movement",
      y: "count",
      fill: "movement",
      stroke: "white"
...
## Movement responses - movement institutionalisation

movement has become more institutionalised
<!-- ynm -->
	

```{ojs}
// need to replace 'm_institutionalised'

m_institutionalisedCounts = aq.from(surveyResults)
  .groupby("m_institutionalised", "movement")
  .count()
  .objects();

plot_m_institutionalised= Plot.plot({
  marks: [
    Plot.frame({
      fill: "#f7f7f7",
      stroke: "black",
    ...
    Plot.barY(m_institutionalisedCounts, {
      fx: "m_institutionalised",
      x: "movement",
      y: "count",
      fill: "movement",
      stroke: "white"
...
## Movement responses - influential ideas 

movement's ideas remain influential
<!-- likert -->

```{ojs}
// need to replace 'm_ideas_influential'

m_ideas_influentialCounts = aq.from(surveyResults)
  .groupby("m_ideas_influential", "movement")
  .count()
  .objects();

plot_m_ideas_influential = Plot.plot({
  marks: [
    Plot.frame({
      fill: "#f7f7f7",
      stroke: "black",
    ...
    Plot.barY(m_ideas_influentialCounts, {
      fx: "m_ideas_influential",
      x: "movement",
      y: "count",
      fill: "movement",
      stroke: "white"
...
[No questions about the assigned movements next meeting]{style="color:violet;"}
